...
fn part1(input: &str) -> u64 {
    ...
    while right_id > left_id {
        ...
        let left_checksum = sum_checksum_range_loop(block, left.used, left_id as u64);
        println!(
        ...
        while left.free > 0 && right_id > left_id {
            ...
            let right_fragment_checksum = sum_checksum_range_loop(block, can_fill, right_id);
            println!(
    ...
    let last_remaining_checksum = sum_checksum_range_loop(block, right_remaining, right_id);
    println!(
